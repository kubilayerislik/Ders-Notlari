...
![[Başlıksız Diyagram.drawio(1).png]]
...
$$ NET_{2} =\left ( 0 \times 0,570345 \right )+\left ( 0 \times -0,328932 \right )+\left ( 1 \times -0,115223 \right ) = -0,115223$$ Ara katman ünitelerinin çıktıları ise şöyle hesaplanır.
...
$$ A^{a}_{21}\left (t \right)= 0,752621- 0,020135 = 0,732486$$ $$ \beta^{c}_{1}\left (t \right)= -0,993423- 0,042730 = - 1,036153 $$
